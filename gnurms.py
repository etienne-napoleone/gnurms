...
rms = ("I'd just like to interject for a moment. What {} is referring to as "
       ...
       "of GNU which is widely used today is often called “Linux”, and many "
       "of its users are not aware that it is basically the GNU system, "
       "developed by the GNU Project.\n\nThere really is a Linux, and these "
       "people are using it, but it is just a part of the system they use. "
